...
lmos = [
        ...
        FrankWolfe.KNormBallLMO(5, 5),
        FrankWolfe.KNormBallLMO(10, 5),
        FrankWolfe.KNormBallLMO(10, 5),
        FrankWolfe.LpNormLMO{1.5}(5),
        FrankWolfe.LpNormLMO{1.5}(50),
        FrankWolfe.LpNormLMO{1.5}(50),
        FrankWolfe.LpNormLMO{2}(5),
        FrankWolfe.LpNormLMO{2}(50),
        FrankWolfe.LpNormLMO{2}(50),
        FrankWolfe.LpNormLMO{Inf}(5),
        FrankWolfe.LpNormLMO{Inf}(50),
        FrankWolfe.LpNormLMO{Inf}(50),
        ]
d =    [
        zeros(10),
