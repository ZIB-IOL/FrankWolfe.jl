...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(print_callback)),NamedTuple{(:print_header,), Tuple{Bool}},typeof(print_callback),Vector{String},String})   # time: 0.046129137
    ...
    end   # time: 0.014159962
    Base.precompile(Tuple{Core.kwftype(typeof(print_callback)),NamedTuple{(:print_footer,), Tuple{Bool}},typeof(print_callback),Nothing,String})   # time: 0.003658263
    Base.precompile(Tuple{Type{Adaptive}})   # time: 0.001834929
