...
# Base.precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{2}, Axes, F, Args} where {Axes, F, Args<:Tuple}},typeof(-),Tuple{Matrix{Float64}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{2}, Nothing, typeof(*), Tuple{Float64, Matrix{Float64}}}}})   # time: 0.001378104
...
# #moi
# Base.precompile(Tuple{typeof(Base.Broadcast.materialize!),Vector{Float64},Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(*), Tuple{Int64, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(-), Tuple{Vector{Float64}, Vector{Float64}}}}}})   # time: 0.019326707
# Base.precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(*),Int64,Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(-), Tuple{Vector{Float64}, Vector{Float64}}}})   # time: 0.006858535
# Base.precompile(Tuple{typeof(Base.CoreLogging.current_logger_for_env),Base.CoreLogging.LogLevel,Symbol,Module})   # time: 0.013862193
...
# Base.precompile(Tuple{Core.kwftype(typeof(print_callback)),NamedTuple{(:print_header,), Tuple{Bool}},typeof(print_callback),Vector{String},String})   # time: 0.001508915
# Base.precompile(Tuple{typeof(Printf.format),Base.TTY,Printf.Format{Base.CodeUnits{UInt8, String}, NTuple{7, Printf.Spec{Val{'s'}}}},String,String,Vararg{String, N} where N})   # time: 0.06262159
# Base.precompile(Tuple{typeof(Printf.format),Vector{UInt8},Int64,Printf.Format{Base.CodeUnits{UInt8, String}, NTuple{7, Printf.Spec{Val{'s'}}}},String,Vararg{String, N} where N})   # time: 0.027797861
# Base.precompile(Tuple{Type{Printf.Format},Base.CodeUnits{UInt8, String},Vector{UnitRange{Int64}},Tuple{Printf.Spec{Val{'s'}}, Printf.Spec{Val{'s'}}, Printf.Spec{Val{'e'}}, Printf.Spec{Val{'e'}}, Printf.Spec{Val{'e'}}, Printf.Spec{Val{'e'}}, Printf.Spec{Val{'e'}}}})   # time: 0.001206295