...
x0 = deepcopy(x00)
res_accel_simplex = FrankWolfe.blended_conditional_gradient(
    f,
    grad!,
    lmo,
    x0,
...
x0 = deepcopy(x00)
res_simplex = FrankWolfe.blended_conditional_gradient(
    f,
    grad!,
    lmo,
    x0,
...
x0 = deepcopy(x00)
res_bcg_convex = FrankWolfe.blended_conditional_gradient(
    f,
    grad!,
    lmo,
    x0,
...
data = [res_accel_simplex.traj_data, res_simplex.traj_data, res_bcg_convex.traj_data]
