...
x, v, primal, dual_gap, status, trajectory_away, active_set = FrankWolfe.away_frank_wolfe(
    f,
    grad!,
    lmo,
    x0,
...
x, v, primal, dual_gap, status, trajectory_away_outplace, active_set = FrankWolfe.away_frank_wolfe(
    f,
    grad!,
    lmo,
    x0,
